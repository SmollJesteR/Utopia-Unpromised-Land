...
class Player(pygame.sprite.Sprite):
    ...
    def animate(self):  # Ashen Knight animations
    ...
    def animate2(self):  # Blood Reaper animations
            up_animations = [self.game.character_spritesheet2.get_sprite(15,12,47,51),
                               self.game.character_spritesheet2.get_sprite(79,12,43,50),
                               self.game.character_spritesheet2.get_sprite(143,12,42,51),
                               self.game.character_spritesheet2.get_sprite(207,13,43,51),
                               self.game.character_spritesheet2.get_sprite(271,12,46,52),
                               self.game.character_spritesheet2.get_sprite(335,12,47,50),
                               self.game.character_spritesheet2.get_sprite(399,12,47,51),
                               self.game.character_spritesheet2.get_sprite(463,12,47,51),
                               self.game.character_spritesheet2.get_sprite(527,12,47,52)
                               ]
            left_animations = [self.game.character_spritesheet2.get_sprite(7,76,38,51),
                             self.game.character_spritesheet2.get_sprite(78,77,32,50),
                             self.game.character_spritesheet2.get_sprite(138,76,37,50),
                             self.game.character_spritesheet2.get_sprite(201,76,37,50),
                             self.game.character_spritesheet2.get_sprite(262,76,41,50),
                             self.game.character_spritesheet2.get_sprite(324,77,44,49),
                             self.game.character_spritesheet2.get_sprite(390,76,41,51),
                             self.game.character_spritesheet2.get_sprite(457,76,37,51),
                             self.game.character_spritesheet2.get_sprite(522,76,37,51)
                             ]
            down_animations = [self.game.character_spritesheet2.get_sprite(15,140,47,51),
                               self.game.character_spritesheet2.get_sprite(79,140,43,51),
                               self.game.character_spritesheet2.get_sprite(143,140,42,51),
                               self.game.character_spritesheet2.get_sprite(207,141,43,51),
                               self.game.character_spritesheet2.get_sprite(271,140,46,52),
                               self.game.character_spritesheet2.get_sprite(335,140,47,51),
                               self.game.character_spritesheet2.get_sprite(399,140,47,51),
                               self.game.character_spritesheet2.get_sprite(463,141,46,51),
                               self.game.character_spritesheet2.get_sprite(527,140,47,52)
                               ]
            right_animations = [self.game.character_spritesheet2.get_sprite(19,204,38,51),
                                self.game.character_spritesheet2.get_sprite(82,205,32,50),
                                self.game.character_spritesheet2.get_sprite(145,204,37,50),
                                self.game.character_spritesheet2.get_sprite(210,204,37,50),
                                self.game.character_spritesheet2.get_sprite(273,204,41,50),
                                self.game.character_spritesheet2.get_sprite(336,205,44,49),
                                self.game.character_spritesheet2.get_sprite(401,204,41,51),
                                self.game.character_spritesheet2.get_sprite(466,204,37,51),
                                self.game.character_spritesheet2.get_sprite(529,204,37,51)
                                ]
            
            if self.facing == "down":
                if self.y_change == 0:
                    self.image = self.game.character_spritesheet2.get_sprite(15,140,47,51)
                else:
                    self.image = down_animations[math.floor(self.animation_loop)]
                    self.animation_loop += 0.1
                    if self.animation_loop >= 9:
            ...
            if self.facing == "up":
                if self.y_change == 0:
                    self.image = self.game.character_spritesheet2.get_sprite(15,12,47,51)
                else:
                    self.image = up_animations[math.floor(self.animation_loop)]
                    self.animation_loop += 0.1
                    if self.animation_loop >= 9:
            ...
            if self.facing == "left":
                if self.x_change == 0:
                    self.image = self.game.character_spritesheet2.get_sprite(7,76,38,51)
                else:
                    self.image = left_animations[math.floor(self.animation_loop)]
                    self.animation_loop += 0.1
                    if self.animation_loop >= 9:
            ...
            if self.facing == "right":
                if self.x_change == 0:
                    self.image = self.game.character_spritesheet2.get_sprite(19,204,38,51)
                else:
                    self.image = right_animations[math.floor(self.animation_loop)]
                    self.animation_loop += 0.1
                    if self.animation_loop >= 9:
...
class Wall(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        # Gunakan sprite yang berbeda dari Block
        self.image = self.game.stonewall_spritesheet.get_sprite(0, 0, self.width, self.height)
...
class Tree2(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        # Gunakan sprite yang berbeda dari Block
        self.image = self.game.tree2_spritesheet.get_sprite(0, 0, self.width, self.height)
